# Practice DP-800 with Microsoft Copilot
...
<div class="qz-grid" id="qzGrid">
  <a class="qz-card" data-prompt="You are a Microsoft DP-800 SQL AI Developer (beta) certification practice-exam coach. Quiz me one question at a time, exam-style. After I answer, tell me if I am right, give the correct answer, and a 2-3 line explanation tied to official Microsoft Learn. Cover all DP-800 domains: Design and develop database solutions (in-memory OLTP, temporal, external, ledger, graph tables, JSON, advanced T-SQL with CTEs, window functions, REGEXP_LIKE, MATCH, error handling, AI-assisted dev with GitHub Copilot, Copilot in Fabric, MCP); Secure optimize and deploy (Always Encrypted with secure enclaves, DDM, RLS, Managed Identity, auditing, Microsoft Purview, Query Store, DMVs, Intelligent Query Processing, SQL Database Projects, DACPAC, GitHub Actions OIDC, Data API Builder, CDC, Change Event Streaming, Azure Functions SQL trigger); Implement AI capabilities (sp_invoke_external_rest_endpoint, embeddings, VECTOR data type, ANN/ENN vector index, VECTOR_DISTANCE, VECTOR_SEARCH, full-text and semantic search, hybrid + RRF, RAG inside Azure SQL). Do not show the answer until I commit. Start with question 1 now." data-target="copilot" href="#"><span class="qz-eyebrow">Full exam mode</span><h3>Sequential Practice Exam</h3><p>Exam-style questions across every DP-800 domain. One at a time, with a Microsoft Learn-grounded explanation after each answer.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="Microsoft DP-800 rapid-fire mode: ask me 20 short multiple-choice questions, one at a time. After each I answer, give one-line correctness and the right answer. At the end give my score and the 3 weakest topics with Microsoft Learn links to study. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Speed round</span><h3>Rapid-Fire (20 questions)</h3><p>Twenty short multiple-choice items back-to-back. Final score plus a ranked list of your three weakest topics with study links.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="You are a Microsoft DP-800 coach. Drill me on Azure SQL service decision trees (table type selection, security control selection, search strategy: full-text vs semantic vs vector vs hybrid). Give a real-world scenario and 4 plausible options. Wait for my answer, then explain why the right service wins and why the others are traps. After I answer, give the next scenario. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Service selection</span><h3>Decision-Tree Drills</h3><p>Table type, security control, and search strategy scenarios with four plausible options. Distractors explained, not just the right answer.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="You are a Microsoft DP-800 coach. Quiz me on the 50 most common gotchas and trick distinctions on the exam (AE vs DDM, ANN vs ENN, CDC vs CES, ledger updateable vs append-only, recursive CTE cap). One at a time, multiple choice, then explanation. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Trick questions</span><h3>Gotcha and Trap Drill</h3><p>The 50 most-confused exam distinctions: AE vs DDM, ANN vs ENN, CDC vs CES, ledger flavors, recursive CTE caps.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="You are a Microsoft DP-800 architecture coach. Give me one design scenario at a time (org size, requirements, constraints). I will propose an Azure SQL + AI architecture. You critique it against the Well-Architected Framework and give the official-pattern answer. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Design scenarios</span><h3>Architecture Critique</h3><p>You propose an architecture; Copilot grades it against the Well-Architected Framework and gives the official-pattern answer.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="I just took the DP-800 practice exam. First ask me which 2 domains I want to drill. Then ask 10 deeper scenario questions on those domains with detailed explanations referencing Microsoft Learn. Begin by asking which domains." data-target="copilot" href="#"><span class="qz-eyebrow">Targeted study</span><h3>Weak-Area Deep Dive</h3><p>Tell Copilot the two domains you struggle with and get ten deeper scenario questions on those areas only.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
</div>

<div class="qz-alt">
  <button data-prompt="You are a Microsoft DP-800 SQL AI Developer (beta) certification practice-exam coach. Quiz me one question at a time, exam-style. After I answer, tell me if I am right, give the correct answer, and a 2-3 line explanation tied to official Microsoft Learn. Cover all DP-800 domains: Design and develop database solutions (in-memory OLTP, temporal, external, ledger, graph tables, JSON, advanced T-SQL with CTEs, window functions, REGEXP_LIKE, MATCH, error handling, AI-assisted dev with GitHub Copilot, Copilot in Fabric, MCP); Secure optimize and deploy (Always Encrypted with secure enclaves, DDM, RLS, Managed Identity, auditing, Microsoft Purview, Query Store, DMVs, Intelligent Query Processing, SQL Database Projects, DACPAC, GitHub Actions OIDC, Data API Builder, CDC, Change Event Streaming, Azure Functions SQL trigger); Implement AI capabilities (sp_invoke_external_rest_endpoint, embeddings, VECTOR data type, ANN/ENN vector index, VECTOR_DISTANCE, VECTOR_SEARCH, full-text and semantic search, hybrid + RRF, RAG inside Azure SQL). Do not show the answer until I commit. Start with question 1 now." data-target="gemini">Open same prompt in Google Gemini</button>
...
> [!IMPORTANT]
> [Microsoft Learn](https://learn.microsoft.com) is the authoritative source for DP-800 content. Use any LLM as a study aid and always confirm specific service limits, region availability, and pricing on the official Microsoft Learn pages linked throughout this guide.
